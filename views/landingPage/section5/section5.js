                    ...
                    <Fade duration = {2000} right>
                        <div id = "myslides" style = {{width: '666px'}}>
                            ...
                            <div id = "pre3">
                                ...
                                <p className = {styles.rightText}><span style = {{color: '#D1AB49'}}>1. 90% of professionals</span> believe that business travel is valuable to the company and professional growth.<br/><br/>2. Approximately 28% of current business would be lost if employees didn't travel.<br/><br/>3. Companies gain $12.50 in revenue for every dollar invested in business travel.<br/><br/>On average US executives state that the return of the business travel is between $10 and $14.99 for every dollar invested.</p>
                            </div>
                        </div>
                    </Fade>
                </div>  
